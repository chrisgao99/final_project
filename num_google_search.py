...
start_date = datetime(2025, 1, 3)  # Set to match the earliest date in MyActivity.json
...
# Read the search activity from MyActivity.json file
with open('MyActivity.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
...
output_data = {
    ...
    "number_of_search": list(daily_counts.values())
}

# Write to output JSON file
with open('daily_google_search_counts.json', 'w', encoding='utf-8') as f:
    json.dump(output_data, f, indent=4)

print("Output written to 'daily_google_search_counts.json'")