...
plt.title("Google Search Counts Over Time (2025-01-03 to 2025-04-17)")
plt.xticks(rotation=45)
plt.grid(True)
plt.legend()
plt.tight_layout()
plt.savefig("google_search_counts_time_series.png")
plt.close()
...
# Print averages
print("Average Google Search Counts by Day of the Week:")
...
plt.title("Average Google Search Counts by Day of the Week")
plt.grid(axis='y')
plt.tight_layout()
plt.savefig("google_search_counts_by_day.png")
plt.close()

print("Plots saved as 'google_search_counts_time_series.png' and 'google_search_counts_by_day.png'")